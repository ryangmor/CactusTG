...
local function run(msg, matches)
  if matches[1]:lower() == 'cactus' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "cactus" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (cactus)",-- Put everything you like :)
		"^[!/]([Cc]actus)"-- Put everything you like :)
    }, 
  run = run
}
